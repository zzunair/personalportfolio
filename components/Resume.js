    ...
    <section className="py-16 bg-black text-white" id="resume">
      <div className="container mx-auto px-8">
        ...
        <p className="text-gray-300 mb-10">
          Highly motivated and results-driven individual with experience in high
          tech environments and a proven track record of success as a senior
          Shopify developer. Skilled in supervising projects, training new
          interns, and continuously learning new Shopify app development to stay
          ahead of the curve. Seeking to leverage my skills and experience to
          make a positive impact as a key player in a challenging and creative
          work environment.
        </p>
        ...
        <div className="grid md:grid-cols-2 gap-x-10">
          ...
          <div>
            ...
            <a
              href="https://www.credly.com/badges/e9433e5b-83e8-4947-adbf-7e6cb8addc06"
              target="_blank"
            >
              <TimelineItem
          ...
          <div>
            ...
            >
              <ul className="list-disc pl-5 space-y-2">
                <li>
                  Working as a Shopify, BigCommerce, WooCommerce, and Full-stack
                  developer on UpWork.
                </li>
                ...
                <li>
                  Collaborate with clients to enhance online stores and create
                  seamless user experiences.
                </li>
                <li>
                  Focus on technical precision, responsiveness, and
                  client-focused outcomes.
                </li>
                <li>
                  Contribute to the success of projects for businesses across
                  diverse industries.
                </li>
              </ul>
            </TimelineItem>
            ...
            >
              <ul className="list-disc pl-5 space-y-2">
                <li>
                  I've worked with more than 25 clients and 40+ shopify stores.
                </li>
                <li>
                  I am an experienced Shopify developer with a track record of
                  successfully delivering projects for over 25 clients, which
                  includes developing more than 40 Shopify stores from scratch.
                </li>
                <li>
                  I have a proven ability to lead projects and have experience
                  in developing B2B and B2C Shopify stores.
                </li>
                <li>
                  Managed teams of designers and developers for projects,
                  ensuring that the end product aligns with the client's needs
                  and specifications.
                </li>
                <li>
                  With my expertise in Shopify development, leadership skills,
                  and my passion for creating effective eCommerce solutions, I
                  am committed to delivering the highest quality work for my
                  clients.
                </li>
                <li>
                  Apart from Shopify, I'm also working providing services in
                  BigCommerce and React JS projects.
                </li>
              </ul>
            </TimelineItem>
            ...
            >
              <ul className="list-disc pl-5 space-y-2">
                <li>
                  Developed numerous websites and worked on different stacks
                  (Shopify, MERN Stack, WordPress).
                </li>
                <li>
                ...
                <li>
                  Created 30+ Shopify stores and proposals for clients and
                  account managers
                </li>
              </ul>
            </TimelineItem>
            ...
            >
              <ul className="list-disc pl-5 space-y-2">
                <li>
                  Developed numerous real estate websites and worked on
                  different projects.
                </li>
                <li>
